...
| Tra/striped catfish (pangasius) | 1.12 on the reference diet; 0.80–1.20 across the trial's seven diets (seed: 1.1) | pond hapa-net-cage fingerlings, 16.1→229.4 g over 112 d (4 months) at 28.6 °C avg (27.2–30.1); duration cross-checked against the paper's own DWG and SGR columns | Da, C.T., Lundh, T. & Lindberg, J.E. (2016) "Growth performance, feed utilisation and biological indices of Tra catfish (*Pangasianodon hypophthalmus*) cultured in net cages in pond fed diets based on locally available feed resources", *International Aquatic Research* 8:309–321, DOI 10.1007/s40071-016-0144-z (open access, Table 4 read) | full text |
