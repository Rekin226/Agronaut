...
_proposals = contextvars.ContextVar("agronaut_proposals", default=None)
...
def set_current(memory_store, user_id: str, followups=None, community=None,
                calibration=None, readings=None, proposals=None) -> None:
...
def get_proposals():
    """Return the ProposalStore for the in-flight message, or None if unset."""
    return _proposals.get()
